...
<footer id="colophon" class="s-footer">
	...
	<?php
	$footer_heading = get_field('heading', "option");
	$footer_text = get_field('descriptions', "option");
	...
	$insta_link = $social_link['insta_link'];
	$pinterest_link = $social_link['pinterest_link'];
